...
mongoose.connect('mongodb+srv://218x1a4431:juned31@cluster0.51ium.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',{
    ...
    app.post('/register', async (req, res) => {
        try {
          ...
          res.status(200).json(user); // Respond with user data after successful registration
        } catch (err) {
...
app.post('/login', async (req, res) => {
    try {
      ...
      // Respond with user details (exclude sensitive data)
      res.status(200).json({
        _id: user._id,
